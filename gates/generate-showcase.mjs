...
// it: it exists for Kenny to look at, which is the same reason
// docs/archive/ADOPTION_PROMPTS.md is Dutch, stated in its own opening. Everything the page NAMES — classes, tokens, file names —
