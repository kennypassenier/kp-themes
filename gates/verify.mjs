...
// `[412/2636] [firefox] › tests/x.spec.mjs:31:5 › name` over one line:
...
const PHASES = [
    ...
    {
        name: 'browser',
        what: fast ? 'the whole suite, Firefox only (--fast)' : 'the whole suite, Chromium and Firefox — about 2636 tests, six minutes',
        command: 'npx',
