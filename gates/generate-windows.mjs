 ...
 * tooltips their backdrop and border colour.
 * @param {Desk | null} d
 */
function windhawkTranslucent(d) {
    const border = d === null ? '0' : hex(d.c.signal).slice(1);
    const dark = d === null || d.dark ? 1 : 0;
...
# Menus, tooltips and ordinary windows: acrylic backdrop, ${d === null ? 'the accent colour' : `KP ${d.label}'s signal colour`} as the border.
type: acrylicblur
