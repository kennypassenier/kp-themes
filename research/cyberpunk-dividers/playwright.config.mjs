// The cyberpunk dividers research demo's own Playwright run, firefox only. Not
// part of the suite: it lives beside the research it verifies. Run it from the
// repository root with
//   KP_TEST_PORT=4619 npx playwright test -c research/cyberpunk-dividers/playwright.config.mjs
...
const PORT = Number(process.env.KP_TEST_PORT ?? 4619);
...
export default defineConfig({
    ...
    webServer: {
        ...
        cwd: '../..',
        url: `http://127.0.0.1:${PORT}/research/cyberpunk-dividers/demo.html`,
