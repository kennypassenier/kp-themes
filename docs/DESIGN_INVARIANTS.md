...
| DI2 two-channel focus ring | pass | pass | pass | pass | pass | pass | pass |
| DI3 states carry their text | pass | pass | pass | pass | pass | pass | pass |
| DI3 states are visible as states [KT2] | pass | pass | pass | pass | pass | pass | pass |
| DI4 badge plates read against their surface [KT2] | pass | pass | pass | pass | pass | pass | pass |
...
**What is left, and where it belongs.** One row reads `not gated`, and
that is the honest word for it. DI9 is a review question about the
generated stylesheet — whether theme colour stays in the token layer
instead of leaking into element rules — and nothing reads it yet.

L3's exit criterion was "the compliance table reads pass everywhere". It
could not be reached from the token layer alone: DI2 needed a CSS rule,
which L4 wrote, and DI9 needs a check nobody has written. A table that
printed `pass` for an invariant nobody measures would be worth less than
one that admits the gap. Queued as L3-EXIT.
