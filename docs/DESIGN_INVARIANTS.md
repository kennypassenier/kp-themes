...
and his choice then stands.

**Amended 2026-09-09.** The original rule went on to require that every
override be recorded beside the gate that it exempts, so a reader saw a
deliberate exception rather than an oversight. Keeping that list was
itself the cost: it grew per theme, per token and per demo, and it made
every design decision an argument with a script. Kenny's instruction is
that the accessibility invariants — the contrast floors (DI1, DI2, DI3),
the flash threshold (DI5), the reduced-motion guards (DI7) and the
texture ceiling (DI9) — become **advice**: measured by `npm run advice`,
read when he asks for the reading, and never a blocking verdict. There is
no exemption list any more, because there is nothing left to be exempt
from.

What is lost is stated rather than hidden: a theme can now ship below
4.5:1, and nothing but a person reading the advice will notice. The
invariants below stay written down in full — they are the questions worth
asking, and they are the measurement the advice performs.
...
| Section | Enforcement |
| --- | --- |
| **1 · Measured at the token layer** | a script checks it against the stylesheet; since 2026-09-09 the accessibility ones report (`npm run advice`) and the rest still break the build |
...
| ring colour | formal | light | dark | cyberpunk | pastel | terminal | forest |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| forest | 1.0 draft/offer | 16/21 | 13.1 |
...
build above threshold. A run that plays once is rated over the second it
occupies — one fade in 320 ms is one change per second, not 3.1 — while
a loop is extrapolated, because it does loop; a burst of four changes in
320 ms still reads four (round six, C2). Every effect the register ships
carries its rate in the DI5 report `check-motion` prints, and per S42 a
finding is written down and shown rather than silently corrected.
...
`docs/archive/legacy/THEMING.md` before this round, and it is the reasoning behind
...
Generated by `node gates/compliance.mjs`; `npm run advice` reports when this table and the code disagree, and since 2026-09-14 never refuses a commit over it [scope-76]. The table says what is measured, not what is refused: since 2026-09-09 the accessibility readings (DI1, DI2, DI3, DI5, DI7, DI9) run in `npm run advice` and report, while the rest still block a commit [Kenny].

| Invariant | formal | light | dark | cyberpunk | synthwave | pastel | terminal | forest | high-contrast | sepia | blueprint | solstice | brutalism | deco | phantom | shade-light | shade-dark | retro | grotesk | lapis | nostromo | titanium |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DI1 boundaries at 3:1 | pass | pass | FAIL | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | FAIL |
| DI2 two-channel focus ring | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |
| DI3 states carry their text | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | FAIL |
| DI3 states are visible as states [KT2] | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |
| DI4 badge plates read against their surface [KT2] | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |
| DI4 opposed status plates distinguishable | pass | pass | FAIL | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | FAIL |
| DI5 flash threshold | pass | pass | n/a | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |
| DI6 declares colour-scheme and layers rise | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |
| DI7 reduced motion honoured | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |
| DI9 theme colour stays in the token layer | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass | pass |

- All 22 themes pass on 51 pairs (41 at 4.5, 10 at 3.0, incl. 7 status badges), 5 pairs held apart in the shipped stylesheet; 38 tokens are exempt with a stated reason.
- All 22 themes declare the same 98 token names (4 known exceptions, L3 clears them).
...
the package's `kp-alarm-jitter`, `kp-alarm-caret` and
...
package's default arrives whole. The DI5 report rated the package's
`kp-alarm-flicker-in` (0, 1, 0.3, 1) at 3.00 per second, the whole budget of
the second it played in; since scope-100 ("Ondieper, en opnieuw kijken") the
panel runs cyberpunk's own `kp-alarm-cyberpunk-flicker` (0, 0.6, a sag to
0.52, 1), which the report rates at 1.00 per second.
