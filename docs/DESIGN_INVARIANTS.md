...
- All 25 themes pass on 49 pairs (39 at 4.5, 10 at 3.0, incl. 7 status badges), 5 pairs held apart in the shipped stylesheet; 36 tokens are exempt with a stated reason.
- All 25 themes declare the same 94 token names (0 known exceptions, L3 clears them).
