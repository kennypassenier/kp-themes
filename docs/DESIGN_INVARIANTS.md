...
| DI9 theme colour stays in the token layer | pass | pass | pass | pass | pass | pass | pass |

- All 7 themes pass on 39 pairs (30 at 4.5, 9 at 3.0, incl. 7 status badges), 5 pairs held apart in the shipped stylesheet; 18 tokens are exempt with a stated reason.
- All 7 themes declare the same 65 token names (0 known exceptions, L3 clears them).
