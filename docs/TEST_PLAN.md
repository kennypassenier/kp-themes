...
what this release has instead is thirty-two gates, 2,636 browser tests
...
- **Nothing compares how the page looks.** Every check here is a number —
  ...
  while every one of the 2,636 tests passes. The cost is real and was paid once already: at
...
suite is 2,636 tests over 92 files across both engines and 1,318 in
