...
Moved again 2026-09-14 (scope-77): `docs/legacy/` became
`docs/archive/legacy/`, next to the dated records archived the same day.
Everything under `docs/archive/` is out of the document index, the path
and privacy gates and the npm package.
