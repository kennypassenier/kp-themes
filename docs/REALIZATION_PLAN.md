...
| C6 | **in progress** 2026-09-08 — Q1 (renamed delivery of the seven Reserved-Font-Name families, Orbitron included), Q3 (AR42's copy clause struck), Q6 (nishiki's synthetic bold as a known limitation), the migration note, the documents, the version; each document through an approval form; the alpha tag only on Kenny's go. |
