...
| `dist/kp-themes.css` | 1649.0 kB | 812.1 kB | 51% |
| `dist/kp-themes.js` | 416.1 kB | 218.2 kB | 48% |

The loose stylesheets together weigh **1705.4 kB** authored and
**844.9 kB** minified, 50% less. A page loading one theme's
