...
| `dist/kp-themes.css` | 1342.5 kB | 712.5 kB | 47% |
| `dist/kp-themes.js` | 229.8 kB | 123.2 kB | 46% |

The loose stylesheets together weigh **1400.1 kB** authored and
**747.9 kB** minified, 47% less. A page loading one theme's
