...
| `dist/kp-themes.css` | 1351.4 kB | 717.6 kB | 47% |
| `dist/kp-themes.js` | 229.9 kB | 123.2 kB | 46% |

The loose stylesheets together weigh **1411.5 kB** authored and
**754.9 kB** minified, 47% less. A page loading one theme's
