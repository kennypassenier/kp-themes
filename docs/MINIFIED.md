...
| `dist/kp-themes.css` | 1675.8 kB | 817.5 kB | 51% |
| `dist/kp-themes.js` | 419.2 kB | 220.0 kB | 48% |

The loose stylesheets together weigh **1732.2 kB** authored and
**850.3 kB** minified, 51% less. A page loading one theme's
