...
| `dist/kp-themes.css` | 1484.2 kB | 737.8 kB | 50% |
| `dist/kp-themes.js` | 394.6 kB | 206.3 kB | 48% |

The loose stylesheets together weigh **1539.7 kB** authored and
**770.3 kB** minified, 50% less. A page loading one theme's
