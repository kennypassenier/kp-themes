...
| `dist/kp-themes.css` | 1527.0 kB | 755.4 kB | 51% |
| `dist/kp-themes.js` | 399.7 kB | 209.2 kB | 48% |

The loose stylesheets together weigh **1582.4 kB** authored and
**788.0 kB** minified, 50% less. A page loading one theme's
