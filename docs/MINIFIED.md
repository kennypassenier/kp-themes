...
| `dist/kp-themes.css` | 1288.6 kB | 701.7 kB | 46% |
| `dist/kp-themes.js` | 229.5 kB | 123.3 kB | 46% |

The loose stylesheets together weigh **1346.7 kB** authored and
**737.7 kB** minified, 45% less. A page loading one theme's
