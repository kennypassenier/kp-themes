...
| `dist/kp-themes.css` | 1244.3 kB | 649.7 kB | 48% |
| `dist/kp-themes.js` | 230.6 kB | 123.2 kB | 47% |

The loose stylesheets together weigh **1298.0 kB** authored and
**681.8 kB** minified, 47% less. A page loading one theme's
