...
| `dist/kp-themes.css` | 1512.6 kB | 751.5 kB | 50% |
| `dist/kp-themes.js` | 399.7 kB | 209.2 kB | 48% |

The loose stylesheets together weigh **1568.1 kB** authored and
**784.1 kB** minified, 50% less. A page loading one theme's
