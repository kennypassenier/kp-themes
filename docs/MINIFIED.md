...
| `css/blueprint-register.css` | 50.0 kB | 23.1 kB | 54% |
| `css/brutalism-register.css` | 56.6 kB | 30.8 kB | 46% |
| `css/components.css` | 164.5 kB | 65.0 kB | 60% |
| `css/cyberpunk-register.css` | 63.0 kB | 35.5 kB | 44% |
| `css/dark-register.css` | 52.2 kB | 24.7 kB | 53% |
| `css/deco-register.css` | 47.1 kB | 23.0 kB | 51% |
...
| `css/lapis-register.css` | 44.5 kB | 21.2 kB | 52% |
...
| `css/phantom-register.css` | 60.0 kB | 32.3 kB | 46% |
| `css/retro-register.css` | 69.7 kB | 35.1 kB | 50% |
...
| `css/synthwave-register.css` | 62.1 kB | 34.3 kB | 45% |
| `css/terminal-register.css` | 56.0 kB | 28.9 kB | 48% |
| `css/themes.css` | 175.2 kB | 117.0 kB | 33% |
| `css/titanium-register.css` | 52.1 kB | 24.4 kB | 53% |
| `css/utilities.css` | 8.4 kB | 4.6 kB | 45% |
| `dist/kp-themes.css` | 1442.2 kB | 725.0 kB | 50% |
| `dist/kp-themes.js` | 367.2 kB | 192.7 kB | 48% |

The loose stylesheets together weigh **1496.0 kB** authored and
**757.1 kB** minified, 49% less. A page loading one theme's
