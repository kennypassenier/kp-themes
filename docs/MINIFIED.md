...
| `css/components.css` | 186.2 kB | 70.9 kB | 62% |
...
| `css/retro-register.css` | 96.9 kB | 49.2 kB | 49% |
...
| `dist/kp-themes.css` | 1519.6 kB | 753.5 kB | 50% |
| `dist/kp-themes.js` | 399.7 kB | 209.2 kB | 48% |

The loose stylesheets together weigh **1575.1 kB** authored and
**786.1 kB** minified, 50% less. A page loading one theme's
