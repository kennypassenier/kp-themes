...
| `dist/kp-themes.css` | 1610.6 kB | 799.7 kB | 50% |
| `dist/kp-themes.js` | 410.8 kB | 215.7 kB | 48% |

The loose stylesheets together weigh **1667.0 kB** authored and
**832.5 kB** minified, 50% less. A page loading one theme's
