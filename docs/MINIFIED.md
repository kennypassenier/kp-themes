...
| `dist/kp-themes.css` | 1657.0 kB | 814.6 kB | 51% |
| `dist/kp-themes.js` | 417.9 kB | 219.1 kB | 48% |

The loose stylesheets together weigh **1713.4 kB** authored and
**847.4 kB** minified, 51% less. A page loading one theme's
