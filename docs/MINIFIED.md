...
| `css/dark-register.css` | 62.5 kB | 28.6 kB | 54% |
...
| `css/sepia-register.css` | 51.2 kB | 23.7 kB | 54% |
...
| `dist/kp-themes.css` | 1642.9 kB | 810.2 kB | 51% |
| `dist/kp-themes.js` | 412.3 kB | 216.0 kB | 48% |

The loose stylesheets together weigh **1699.2 kB** authored and
**843.0 kB** minified, 50% less. A page loading one theme's
