...
| `dist/kp-themes.css` | 1511.1 kB | 751.4 kB | 50% |
| `dist/kp-themes.js` | 399.7 kB | 209.2 kB | 48% |

The loose stylesheets together weigh **1566.6 kB** authored and
**784.0 kB** minified, 50% less. A page loading one theme's
