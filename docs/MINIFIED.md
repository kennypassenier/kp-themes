...
| `css/shade-light-register.css` | 53.9 kB | 26.3 kB | 51% |
...
| `dist/kp-themes.css` | 1635.4 kB | 808.2 kB | 51% |
| `dist/kp-themes.js` | 412.3 kB | 216.0 kB | 48% |

The loose stylesheets together weigh **1691.8 kB** authored and
**840.9 kB** minified, 50% less. A page loading one theme's
