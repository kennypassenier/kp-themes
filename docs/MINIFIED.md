...
| `dist/kp-themes.css` | 1483.5 kB | 737.5 kB | 50% |
| `dist/kp-themes.js` | 394.6 kB | 206.3 kB | 48% |

The loose stylesheets together weigh **1539.0 kB** authored and
**770.1 kB** minified, 50% less. A page loading one theme's
