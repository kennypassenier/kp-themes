...
| `css/components.css` | 180.9 kB | 69.7 kB | 61% |
| `css/cyberpunk-register.css` | 65.7 kB | 36.6 kB | 44% |
...
| `css/retro-register.css` | 73.1 kB | 36.1 kB | 51% |
| `css/sepia-register.css` | 46.9 kB | 22.2 kB | 53% |
| `css/shade-dark-register.css` | 43.8 kB | 20.5 kB | 53% |
| `css/shade-light-register.css` | 47.0 kB | 22.4 kB | 52% |
...
| `dist/kp-themes.css` | 1478.3 kB | 736.0 kB | 50% |
| `dist/kp-themes.js` | 384.4 kB | 201.0 kB | 48% |

The loose stylesheets together weigh **1533.8 kB** authored and
**768.6 kB** minified, 50% less. A page loading one theme's
