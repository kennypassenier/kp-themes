...
| `dist/kp-themes.css` | 1275.1 kB | 696.1 kB | 45% |
| `dist/kp-themes.js` | 219.8 kB | 118.0 kB | 46% |

The loose stylesheets together weigh **1333.3 kB** authored and
**732.2 kB** minified, 45% less. A page loading one theme's
