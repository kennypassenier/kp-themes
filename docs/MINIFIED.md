...
| `css/dark-register.css` | 67.2 kB | 29.0 kB | 57% |
...
| `dist/kp-themes.css` | 1661.7 kB | 815.0 kB | 51% |
| `dist/kp-themes.js` | 417.9 kB | 219.1 kB | 48% |

The loose stylesheets together weigh **1718.1 kB** authored and
**847.8 kB** minified, 51% less. A page loading one theme's
