...
| `dist/kp-themes.css` | 1536.0 kB | 759.5 kB | 51% |
| `dist/kp-themes.js` | 399.7 kB | 209.2 kB | 48% |

The loose stylesheets together weigh **1591.5 kB** authored and
**792.1 kB** minified, 50% less. A page loading one theme's
