...
| `dist/kp-themes.css` | 1229.2 kB | 649.1 kB | 47% |
| `dist/kp-themes.js` | 230.0 kB | 123.1 kB | 46% |

The loose stylesheets together weigh **1282.9 kB** authored and
**681.2 kB** minified, 47% less. A page loading one theme's
