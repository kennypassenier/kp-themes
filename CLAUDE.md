...
| Next action         | waiting on Kenny: the step-timing form (a measured timing item in every form, kp-themes only or global); meanwhile an agent builds the verdict register (scope-68)                                                                                                                                  |
