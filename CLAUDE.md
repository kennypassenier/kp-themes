...
| Next gate           | the homelab form: which kp-tui components come next, and whether homelab switches yet [scope-129]                                                                                                                                                                                                                                                           |
| Next action         | waiting on Kenny: the homelab form; kp-tui carries the four components homelab hand-rolls (b846db9)                                                                                                                                                                                                                                                         |
