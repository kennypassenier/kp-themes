...
| Field               | Value                                                                                                                                                                                                                                                                             |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **Round eight, Kijken.** Every component root is on a catalogue page (16 pages, 105 blocks on the review page); the 21 faults of batch 2 are fixed (`829d04e`, gap-11 closed); the data table research (`266720d`) and the grotesk hover options (`7ea23e1`) are ready to look at |
...
| Next action         | waiting on Kenny: the nostromo notes form (select, badge shape, palette matching, accelerator, compositions, nostromo nav, direct fixes) and his look at the grotesk hover demo; in the background the data table round, the batch-3 faults and the switch are being built        |
