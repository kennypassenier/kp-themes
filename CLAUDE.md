...
| Next gate           | the form on Jellyfin, the Ratatui crates and fix-60, once the anatomy proposal is in [scope-125, scope-126]                                                                                                                                                                                                                                                 |
| Next action         | waiting on agent: the anatomy proposal for the 19 themes without one; the tagged suite is running on the VS Code move and fix-60                                                                                                                                                                                                                            |
