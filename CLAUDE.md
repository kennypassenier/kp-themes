...
| Next action         | waiting on Kenny: who publishes the 7.1.0 draft [Procedure 5.1 step 12] — and on `npm run verify`, which is running in the background (557 of 3980 at 23:28 UTC). When it finishes, Claude merges to `main`, tags `v7.1.0` and checks the draft's twelve assets and its checksums; the publish itself waits on the form                                                                                                                                                                                                                                                           |
