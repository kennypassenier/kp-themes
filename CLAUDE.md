...
| Last completed gate | The pre-release form (2026-09-09, REL1-REL4): the badge stays as it is with the measurement recorded, the name stays `@kp-soft/themes`, the field test is skipped by Kenny's own decision, and he looks at the twenty-five locally before `main` moves                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Next gate           | Kenny's own look at the twenty-five, on the local server (REL4). Then `npm run verify` on his command, `main` forward, `v5.0.0` and its draft. The version in the tree is `5.0.0`; the tag waits until the pages please him                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
