...
| Next action         | waiting on Kenny: the review-site form (GitHub Pages, grotesk press, which data table features to build), what his browser shows on catalogue/index.html now that a failing page names its error, and his look at the data table demo's filter designs and the control-height demo                  |
