...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **Round seven (6.0.0), Phase 0 — opened 2026-09-11.** Kenny asked for a new theme called hypertech with the full works, and for what that would mean for the themes that are not so cool yet. Seven items answered on the scope form: three candidate demos judged on sight, a vocabulary for motion (`react`, `commit`, `ambient`) that every theme answers in its own voice, an arrival for all twenty-six with the click-swallowing overlay repaired first, pastel answering in its own risograph language, every gesture defaulting to on, the four waiting queue rows coming along, and the compliance table corrected. Recorded as `scope-1` to `scope-7` in [docs/SCOPE.md](docs/SCOPE.md). The three candidates are at <https://claude.ai/code/artifact/c1e977c6-bab9-434f-90ea-6f3047ca6e2e> |
| Last completed gate | The round-seven scope form, 2026-09-11: all seven items answered. Before it, `v5.1.0` was published (2026-09-10) at <https://github.com/kennypassenier/kp-themes/releases/tag/v5.1.0>, nine assets, verified three ways and then once more anonymously                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Next gate           | Kenny's second look at <https://claude.ai/code/artifact/c1e977c6-bab9-434f-90ea-6f3047ca6e2e>. He chose candidate A on the first cut and asked for three things: more hightech, fewer effects at once, and the destructive control opening the theme's dialog instead of arming in place. All three are in the second cut. Nothing is written into the package until he approves what he sees                                                                                                                                                                                                                                                                                                                                                                                                         |
| Open queue items    | Ten. `step-2` and `step-4` wait on Kenny; `KT6-M1` waits on JobTracker; `step-6` is the compliance repair, which a separate session reports committed on `claude/busy-jones-9d6fff` and unverified here; `gap-5` is the demo that lagged the package's own confirmation. The other five — `CP1`, `gap-1`, `gap-2`, `gap-3`, `gap-4` — are round seven's own work                                                                                                                                                                                                                                                                                                                                                                                                                                      |
