...
| Next action         | waiting on Kenny: the correction form for fix-45 (the same blocks came back in every theme because the tools had anchored their hash), and one pass over the review site to see that nothing comes back; every block/theme pair is approved, 3062 of 3062 [scope-107]                                                                                       |
