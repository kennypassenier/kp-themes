...
| Next action         | waiting on Kenny: one pass on the review site, and the new page <https://kennypassenier.github.io/kp-themes/review/catalogue/round.html> ("Am I through?") which says in one line whether anything is left [fix-48]; a reading is now taken of a block as written, so a field he touched no longer comes back [fix-47]                                      |
