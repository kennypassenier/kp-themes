...
| Next gate           | the form on what kp-tui does next, and on the 7.0.0 release now that Jellyfin, VS Code and the crates are done [scope-129]                                                                                                                                                                                                                                  |
| Next action         | waiting on Kenny: the next-step form; dark is live on the Jellyfin and kp-tui carries the widgets (3fae6ae)                                                                                                                                                                                                                                                 |
