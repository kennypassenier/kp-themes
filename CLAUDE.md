...
| Next gate           | the form on the kp-tui effects: the per-theme fx rows, what returns to kp-themes, where kp-tui is hosted, and the next step [scope-129]                                                                                                                                     |
| Next action         | waiting on Kenny: the effects form (kp-tui cbb31b3 — the effects with the theme holding the knobs); 7.0.0 still held on round-six                                                                                                                                         |
