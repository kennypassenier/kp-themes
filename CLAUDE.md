...
| Field               | Value                                                                                                                                                                                                                                                    |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | Round six (5.0.0), Phase 6, AFK: C0, C1 and C2 built 2026-09-07 (the effects skeleton and seven gates; the 93-token contract and the two surfaces; the signal-yellow register); C3 next                                                                  |
