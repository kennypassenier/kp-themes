...
| Next gate           | Blueprint v3, dark-with-stars II and the woodblock rework of nishiki back to Kenny in one form (with nishiki's name); then the combined ratification of PH, RT, TM, BR and the tag `5.0.0-alpha.2`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
