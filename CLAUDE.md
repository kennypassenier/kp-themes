...
| Next action         | waiting on Kenny: his look at the published review site once the review page stops showing 10 unchanged register blocks as changed in nostromo (an agent fixes the hash drift between review and component pages); do not judge nostromo on the review page until then                              |
