...
| Next gate           | Kenny's next-step form after v6.1.0: the JavaScript split that scope-92 held until the catalogue review (now 3062 of 3062 approved), or the content rounds scope-29 puts last                                                                                                                                                                               |
| Next action         | waiting on Kenny: the next-step form (fix-53 and what follows v6.1.0)                                                                                                                                                                                                                                                                                       |
