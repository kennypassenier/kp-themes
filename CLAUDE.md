...
| Next gate           | The report Kenny is owed for stages 1.1 to 1.3, which closed on commits instead of on a gate. After it, stage 1.4: the side navigation that can be hidden                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
