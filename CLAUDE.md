...
| Next action         | waiting on Kenny: his look at research/control-height/demo.html; meanwhile two background agents build the third-pass fixes (package: date filter, grotesk B, cyberpunk pager, inset bars; demo: add-filter mock), which Claude merges when they report                                             |
