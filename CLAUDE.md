...
| Last completed gate | The combined ratification of the nineteen lifts (2026-09-08): R1–R5 agreed, R6 and R7 shown to Kenny, N1 answered "rename now" — topo → forest, tazhib → lapis, nishiki → woodblock, done and pushed. T1: no tag yet, on Kenny's own words — the tag waits until every item is handled and he is happy with the version                                                                                                                                                                                                                                                                                                                                                                                             |
| Next gate           | Kenny's reading of the four evidence images (R6, R7), then whatever he wants changed, and only then `v5.0.0-alpha.2`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
