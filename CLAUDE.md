...
| Next action         | waiting on Kenny: his look at the published review site once the verdict register is in (an agent builds it, scope-68); every form from now on carries the step-timing item (scope-69)                                                                                                              |
