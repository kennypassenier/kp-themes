...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **7.1.0 is published** (2026-09-20), <https://github.com/kennypassenier/kp-themes/releases/tag/v7.1.0> — twelve assets, 267 of 267 checksums verified against the tagged tree. kp-tui 0.1.0 is tagged and pinned to it, its release still a draft                                                                                                                                                                      |
| Last completed gate | **Procedure 5.1, 2026-09-20.** Verify green in 26 m 44 s, merge, tag, assets, checksums, and Kenny's answer on the release form: Claude publishes                                                                                                                                                                                                                                                                      |
| Next gate           | the closing form: whether Claude publishes kp-tui's draft too, and what comes after two releases                                                                                                                                                                                                                                                                                                                       |
| Next action         | waiting on the tagged browser run (`test:tags --level commit`, 1654 tests, started 01:39 UTC) before the far-edge change is committed [fix-64b]. Then: commit, push `main` **and** `round-six` [fix-69], wait for the Pages run, and the closing form                                                                                                                                                                  |
| Open queue items    | Twenty-seven, in docs/MINI_ROUNDS.md: `step-2`, `gap-9`, `gap-10`, `gap-14`, `gap-15`, `fix-9-M1`, `HA4`, `KT6-M1`, `fix-16-M1` to `fix-18-M1`, `fix-32-M1`, `fix-36-M1`, `fix-38-M1` to `fix-42-M1`, `fix-45-M1` to `fix-51-M1`, `fix-62-M1`, `fix-63-M1`, `fix-64-M2`, `fix-64b-M1`; four were closed on 2026-09-20 because the release was their named moment. None of the rest is Claude's to close before its own |
