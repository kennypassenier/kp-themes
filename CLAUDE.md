...
| Next action         | waiting on Kenny: the test-removal form (scope-32) with its step-timing item; meanwhile an agent builds "+ Add filter" per table and grotesk's black pressed label                                                                                                                                                                      |
