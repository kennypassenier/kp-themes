...
| Next gate           | the deep-dive form on the code-block colour, plus the rebuilt Ratatui buttons [scope-123, fix-58]                                                                                                                                                                                                                                                           |
| Next action         | waiting on Kenny: the code-colour form; fix-57 closed and synced, the Ratatui buttons are on round-six (00068ec2)                                                                                                                                                                                                                                           |
