...
| Last completed gate | **The base-digest form, 2026-09-20.** Kenny's own answer: a separate hash per component, moved only by the code that reaches it. Built as version 9, with `carry` bringing all 3111 approvals onto it                                                                                                                                                       |
| Next gate           | Kenny's review of the 110 pairs the submenu mark moved — the five blocks that hold a side navigation, in 22 themes                                                                                                                                                                                                                                          |
| Next action         | waiting on Kenny: the submenu marks on <https://kennypassenier.github.io/kp-themes/review/catalogue/index.html>, published at 6cdb4173 and fetched back [fix-69]                                                                                                                                                                                            |
| Open queue items    | Fifteen, in docs/MINI_ROUNDS.md: `step-2`, `fix-9-M1`, `KT6-M1`, `fix-16-M1` to `fix-18-M1`, `fix-46-M1`, `fix-51-M1`, `fix-64-M2`, `fix-64b-M1`, `fix-70-M1`, `fix-71-M1`, `scope-136-M1`, `scope-137-M1`. The last one already carries its first reading: 110 of 3084                                                                                     |
