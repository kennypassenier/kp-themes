...
| Next gate           | the form on the last three kp-tui components, CI on the now-public repository, and the next step [scope-130]                                                                                                                                     |
| Next action         | waiting on Kenny: the components form (kp-tui a5841d6, public at github.com/kennypassenier/kp-tui); 7.0.0 still held on round-six                                                                                                                                         |
