...
| Next action         | waiting on Kenny: the after-wave form (the add-filter editor title, the compact form in 18 themes, step timing); meanwhile an agent builds the tags of scope-33                                                                                                                                                                         |
