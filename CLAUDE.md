...
| Last completed gate | **The submenu-mark review, 2026-09-20.** 110 verdicts recorded, 89 approved and 21 rejected; both faults he found are fixed and the rejected pairs carry a note with his words                                                                                                                                                                              |
| Next gate           | Kenny's second look at the five side-navigation blocks: the mark now stands in the name's own line, and nostromo's dot no longer floats                                                                                                                                                                                                                     |
| Next action         | waiting on Kenny: the same 110 pairs, published at 84cfba1e and fetched back [fix-69]. They all come back, the approved with the rejected, because the fix moves the rule all 110 were judged on                                                                                                                                                            |
| Open queue items    | Fifteen, in docs/MINI_ROUNDS.md: `step-2`, `fix-9-M1`, `KT6-M1`, `fix-16-M1` to `fix-18-M1`, `fix-46-M1`, `fix-51-M1`, `fix-64-M2`, `fix-64b-M1`, `fix-70-M1`, `fix-71-M1`, `fix-73-M1`, `scope-136-M1`, `scope-137-M1`                                                                                                                                     |
