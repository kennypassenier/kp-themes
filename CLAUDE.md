...
| Next gate           | The combined ratification of the nineteen lifts: the reported findings each theme carries (S42, S49), the three renames (forest → forest, lapis → lapis, woodblock → woodblock), and then `v5.0.0-alpha.2`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
