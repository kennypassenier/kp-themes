...
| Field               | Value                                                                                                                                                                                                                                              |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **Round seven (6.0.0), Phase 6 — the development loop.** Stage 1 is closed. Stage 2 is under way: all twenty-five themes now carry their own quirk, and the two new themes are in as token layers                                                  |
| Last completed gate | **The two new themes, 2026-09-12.** Twenty-six themes. The spectral instrument replaced dark and titanium joined, both with their signals exactly as their approved demos draw them. Four decisions of Kenny's landed with them                    |
| Next gate           | The two registers. Neither theme has one yet, which is why titanium's hooks row is empty; everything they need exists now — the pointer bus, the button's two paintable surfaces, and a theme's own authored states                                |
