...
| Last completed gate | The consumer-feedback form (2026-09-09, CF1-CF4): chassis-rs adopted 5.0.0 the day it published and reported two gaps, both measured here and both real. Kenny chose the manifest-built tarball, the full export surface on the bundle, both loading routes documented with the numbers, and 5.1.0 now                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Next gate           | `npm run verify` on Kenny's command, then `v5.1.0` and its draft. Then Phase 10, the retrospective, which now also covers what the first outside adoption found                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| AFK mode            | on; 5.1.0 is built and gated, waiting on Kenny's verify run                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
