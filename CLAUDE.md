...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **Round seven (6.0.0), Phase 0 — opened 2026-09-11.** It began as one new theme called hypertech and widened the moment Kenny looked at the whole set: every theme is to earn a quirk of its own, four leave the set, and nine gaps from his element list are answered. Fifteen scope items, `scope-1` to `scope-15`, in [docs/SCOPE.md](docs/SCOPE.md); the per-theme verdicts and the measurements behind them in [docs/THEME_VERDICTS.md](docs/THEME_VERDICTS.md)                            |
...
| Next gate           | Kenny's look at two pages. Four directions for hypertech at <https://claude.ai/code/artifact/c1e977c6-bab9-434f-90ea-6f3047ca6e2e> — the spectral instrument he named as the fallback, plus Cherenkov, Titanium and the command table. And six silhouettes with the world stripped away at <https://claude.ai/code/artifact/e7a287f1-2b9c-4758-a81d-07b997e9f180>, which is where two rounds of evidence point: six worlds refused, and every time it was the shape of a control he wrote about |
