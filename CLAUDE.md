...
| Next gate           | the progress group needs Kenny's eye on the review site: one block changed in 22 themes [fix-64]                                                                                                                                     |
| Next action         | waiting on Kenny: the form on the column rule, the two last Homelab screens and the textured bars                                                                                                                                         |
