...
| Next gate           | Kenny's form on the JavaScript split: whether a change to js/auto.js sends every block back for review [scope-115]                                                                                                                                                                                                                                          |
| Next action         | waiting on Kenny: the review-hash question the split raises (catalogue/code-version.json's shared digest moved); the split is committed locally on round-six and not pushed                                                                                                                                                                                 |
