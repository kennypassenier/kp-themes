...
**State:** `v5.0.0` is tagged on `8252bed`, the head of `main`
(2026-09-09), with its draft release built by
`.github/workflows/release.yml` — eight assets including `fonts.tar` and a
231-line `SHA256SUMS`, each checked against the tagged tree —
**awaiting Kenny's own publish**. 4.0.0 was released 2026-09-07.
...
| Last completed gate | The release (2026-09-09): Kenny ran `npm run verify` green in 5:45, looked at the pages, and gave the go. `main` fast-forwarded 022def1 → 8252bed, `v5.0.0` tagged on it, the draft built and its assets checked against the tagged tree. The site republished and serves `--kp-themes-version: '5.0.0'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Next gate           | Kenny publishes the draft, or asks Claude to. Then Phase 10, the retrospective — and the two consumer prompts he asked for (JobTracker and chassis-rs, each told to copy the files from the directory themselves)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| AFK mode            | on; 5.0.0 is tagged and drafted, and what is left is Kenny's own publish                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
