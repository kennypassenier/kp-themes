...
| Next action         | waiting on Kenny: the correction form for fix-43 (the intro blocks were dead where he judges) and fix-44 (a test run named a file that does not exist); 81 of 3062 pairs open — 16 rejections and 65 approvals on blocks that changed since [scope-112]                                                                                                     |
