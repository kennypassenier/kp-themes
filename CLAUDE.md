...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                       |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **7.1.0 is published** (2026-09-20) and kp-tui 0.1.0 with it. The queue is being worked: the log block is approved in all 22 themes, seven rows closed, and the hash recipe is at version 8 — a block is hashed over the families its markup names [fix-71] and the modules it asks the loader for [scope-136]                                              |
| Last completed gate | **The look-round, 2026-09-20.** Kenny walked the five points and approved all of them, which closed seven rows: the sticky header, dark's chamfer, the select's arrow, the round page, the catalogue opening empty, the round staying finished, and the nineteen pairs of fix-45                                                                            |
| Next gate           | the form on what the base digest holds and how much of it can be attributed                                                                                                                                                                                                                                                                                 |
| Next action         | waiting on Kenny: the form on the base digest. Measured for it: 1253 unnamed lines — 496 `@font-face`, 456 bare selectors, 246 `@keyframes`, 36 print, 19 `:root` — of which 47 of 62 faces belong to one theme and 44 of 83 animations to one family                                                                                                       |
| Open queue items    | Thirteen, in docs/MINI_ROUNDS.md: `step-2`, `fix-9-M1`, `KT6-M1`, `fix-16-M1` to `fix-18-M1`, `fix-46-M1`, `fix-51-M1`, `fix-64-M2`, `fix-64b-M1`, `fix-70-M1`, `fix-71-M1`, `scope-136-M1`. Fourteen closed on 2026-09-20; `fix-46-M1` carries a reading that is Kenny's to judge                                                                          |
