...
| Next gate           | The combined ratification of the four lifted themes (PH, RT, TM, BR), then the tag `5.0.0-alpha.2`; after it, the approval form for the next concept demos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
