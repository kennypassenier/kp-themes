...
| Next action         | waiting on Kenny: his check round on the review site, which now holds still — a round is open (`catalogue/round.json`) and the gates refuse any commit that would move a block under him [fix-46]                                                                                                                                                           |
