...
| Next gate           | the 7.0.0 release form, after npm run verify [scope-119]                                                                                                                                                                                                                                                                                                    |
| Next action         | waiting on agent: Claude's `npm run verify` for 7.0.0, to be run again on 8680a72a after ha-themes.tar; the researcher agent on research/jellyfin and research/ratatui [scope-120]                                                                                                                                                                          |
