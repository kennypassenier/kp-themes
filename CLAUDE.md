...
| Next gate           | the Jellyfin form: permission to read the media stack's Jellyfin, which kp theme replaces the third-party one, and fix-56 again [scope-121]                                                                                                                                                                                                                 |
| Next action         | waiting on Kenny: the Jellyfin form and his run of research/ratatui/demo; 7.0.0 held on round-six (verify green on 2005f24e)                                                                                                                                                                                                                                |
