...
| Next action         | waiting on Kenny: his look at research/control-height/demo.html (then the control-height form), and his next pass on the review page, where the second-pass blocks are back (drag a real file onto the upload zone by hand)                                                                         |
