...
| Next action         | waiting on Kenny: the theme-portraits form (a page per theme showing its essence, and a recipe new components follow); waiting on agent: the four scope-96 agents [scope-96]                                                                                                                                                                                |
