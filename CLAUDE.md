...
| Next gate           | the next-step form: release 7.0.0, the Ratatui crates, or the VS Code generator into the package [scope-124]                                                                                                                                                                                                                                                |
| Next action         | waiting on Kenny: the next-step form; everything approved is on round-six (d7166125) and pushed                                                                                                                                                                                                                                                             |
