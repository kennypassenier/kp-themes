...
| Next gate           | the form on Jellyfin, the anatomy of nineteen themes, the crates and fix-60 [scope-125, scope-126, fix-60]                                                                                                                                                                                                                                                  |
| Next action         | waiting on Kenny: the crates form; VS Code in the package and the anatomy proposal are on round-six (639d0090)                                                                                                                                                                                                                                              |
