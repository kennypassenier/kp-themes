...
| Next action         | waiting on Kenny: the catch-up form (fix-24, fix-25, fix-26, the filter design, control heights, grotesk's hover, step timing); then the test-removal form from the inventory an Explore agent is taking                                                                                                                                |
