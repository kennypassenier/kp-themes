...
| Next gate           | The research form: which navbar pattern, which futuristic layout, which loading strategy, what to do with the five findings, and whether the two catalogue pages are the right shape                                                                                                                                                                                                                        |
| Next action         | waiting on Kenny: the answers to the research-and-catalogue form (seven items)                                                                                                                                                                                                                                                                                                                              |
