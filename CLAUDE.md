...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **Round seven (6.0.0), Phase 0 — opened 2026-09-11.** It began as one new theme called hypertech and widened the moment Kenny looked at the whole set: every theme is to earn a quirk of its own, four leave the set, and nine gaps from his element list are answered. Twelve scope items, `scope-1` to `scope-12`, in [docs/SCOPE.md](docs/SCOPE.md); the per-theme verdicts and the measurements behind them in [docs/THEME_VERDICTS.md](docs/THEME_VERDICTS.md). Three worlds for hypertech are at <https://claude.ai/code/artifact/c1e977c6-bab9-434f-90ea-6f3047ca6e2e> |
...
| Next gate           | Which of the three worlds becomes hypertech. Kenny praised all three without choosing one, so nothing is written into the package until he does — not a token                                                                                                                                                                                                                                                                                                                                                                                                                 |
