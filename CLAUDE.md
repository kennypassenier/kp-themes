...
| Next action         | waiting on Kenny: the gestures-and-shadows form — which scope-25 gestures to build, dark's dialog shadow colour, shade-light's muted text; scope-100's fixes are on the branch                                                                                                                                                                              |
