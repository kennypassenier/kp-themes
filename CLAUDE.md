...
| Next gate           | the form on the proof: which of the three gaps the crate closes, and whether 7.0.0 goes out now [scope-131]                                                                                                                                     |
| Next action         | waiting on Kenny: the proof form (kp-tui ee6d05c, CI green in 33 s); 7.0.0 still held on round-six                                                                                                                                         |
