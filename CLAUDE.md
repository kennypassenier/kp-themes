...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | **7.1.0 is published** (2026-09-20) and kp-tui 0.1.0 with it. The queue is being worked: gap-9, gap-10, gap-14 and gap-15 are closed, the log block is approved in all 22 themes, and the hash recipe is at version 7 [fix-71]                                                                                                                                             |
| Last completed gate | **The hash-reach form, 2026-09-20.** Only the families a block's markup names enter its hash, and the remaining gap is written down rather than closed with a hand-kept list                                                                                                                                                                                               |
| Next gate           | the form on fix-71 and on what Claude picks up next                                                                                                                                                                                                                                                                                                                        |
| Next action         | waiting on Kenny: the correction form for fix-71 and the next step. The recipe is at version 7, `carry` brought 3001 approvals onto it, the snapshot reads 3084 pairs with 0 drifted, and the published review site serves the new recipe                                                                                                                                  |
| Open queue items    | Twenty-six, in docs/MINI_ROUNDS.md: `step-2`, `fix-9-M1`, `KT6-M1`, `fix-16-M1` to `fix-18-M1`, `fix-32-M1`, `fix-36-M1`, `fix-39-M1` to `fix-42-M1`, `fix-45-M1`, `fix-46-M1`, `fix-48-M1` to `fix-51-M1`, `fix-62-M1`, `fix-63-M1`, `fix-64-M2`, `fix-64b-M1`, `fix-69-M1`, `fix-70-M1`, `fix-71-M1`, `gap-14-M1`. None is Claude's to close before its own named moment |
