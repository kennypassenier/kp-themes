...
| Field               | Value                                                                                                                                                                                                                                                    |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | Round six (5.0.0), Phase 6, AFK: C0–C3 built 2026-09-07 (the gates, the 93-token contract and the two surfaces, the signal-yellow register, the effects module); C4 next                                                                                 |
