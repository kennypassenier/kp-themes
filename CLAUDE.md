...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | Round six (5.0.0), Phase 6: PH0–PH4, RT0–RT4, TM0–TM4 and BR0–BR4 built (phantom, retro, terminal, brutalism); **S49 applied 2026-09-08** — Kenny answered the deviation form with "Demo exact" for eleven of twelve groups, and S49-1 … S49-5 are built: one concept page per theme in its own words, retro's window chrome, the demos' token values, phantom's italic faces, the per-theme texture ceiling, the boot lines from the dictionary, the demos' rings and transitions, the combo buttons, and phantom's skewed button (A7, decided on the comparison page). TH111 amended, KT8 yielding per theme with the reason recorded, AR30 reading either ring order. Blueprint v4 and nishiki v2 with Kenny; the combined ratification next |
...
| Next gate           | The combined ratification of PH, RT, TM, BR and the S49 work, then the tag `5.0.0-alpha.2` (draft release; publishing is Kenny's). `main` moves as part of that ratification                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
