...
| Next action         | waiting on Kenny: the test-removal form (scope-32: which tests the catalogue now replaces), built from the inventory an Explore agent is taking; the ruler fix (fix-24) is published                                                                                                                                                    |
