...
| Next gate           | The concept-demo gate: Kenny picks one of the three candidates, or sends them back. Nothing is written into the package until he does — not a token                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Open queue items    | Nine. `step-2` (a full verify run on Kenny's own machine) and `step-4` (the drill half) wait on him; `KT6-M1` waits on JobTracker; `step-6` is the compliance repair, running in a separate session and unverified here. The other five — `CP1`, `gap-1`, `gap-2`, `gap-3`, `gap-4` — are round seven's own work and were answered on the scope form                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
