...
| Next gate           | the form on the cool factor: which of the five moves kp-tui makes next, and when 7.0.0 goes out [scope-132]                                                                                                                                     |
| Next action         | waiting on Kenny: the cool-factor form (kp-tui 9f495ba and the depth pass); 7.0.0 still held on round-six                                                                                                                                         |
