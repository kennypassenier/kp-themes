...
| Next action         | waiting on Kenny: his look at the published review site — the new judging panel and one prompt across pages, the seven data table blocks, the compare page, grotesk option E, the side note; then his choices on the filter design and control heights                                              |
