...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current phase       | Round six (5.0.0), Phase 6: **six themes lifted** — cyberpunk (C0–C6), synthwave (SW0–SW4), phantom, retro, terminal and brutalism (PH/RT/TM/BR 0–4), all four ratified 2026-09-08 together with the S49 pass (S49-1 … S49-5). Kenny's instruction at that ratification: **lift the remaining nineteen themes first, with the progress shown at each step; the release and the tag come after.** Eighteen of those nineteen have an approved demo; blueprint's was approved at its fourth version the same evening. In flight: pastel, blueprint, deco and sepia, each in its own worktree with a Sonnet agent (Kenny, 2026-09-08: parallelise where possible) |
...
| Next gate           | Per lift: the demo-against-register audit (KT15-M1) and its ratification. `main` is to move to the ratified commit — the push is refused by this session's safety classifier, so it waits on Kenny. `v5.0.0-alpha.2` waits until the nineteen are in                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| AFK mode            | on, the nineteen remaining themes in the LIFT_PLAN's order, parallelised over Sonnet agents in worktrees (Kenny, 2026-09-08)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
