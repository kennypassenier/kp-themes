...
| Next action         | waiting on agent: scope-101 — sepia's ink and rule, the pointer light in the shade pair with cards and darker muted text, and a demo of dark's dialog shadow options                                                                                                                                                                                        |
