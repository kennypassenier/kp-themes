export type ThemeName = 'formal' | 'light' | 'dark' | 'cyberpunk' | 'synthwave' | 'pastel' | 'terminal' | 'topo' | 'high-contrast' | 'sepia' | 'blueprint' | 'solstice' | 'brutalism' | 'deco' | 'academia' | 'phantom' | 'ticker' | 'nishiki' | 'shade-light' | 'shade-dark' | 'mono' | 'retro' | 'grotesk' | 'tazhib' | 'nostromo';
 ...
 *
 * @typedef {'formal' | 'light' | 'dark' | 'cyberpunk' | 'synthwave' | 'pastel' | 'terminal' | 'topo' | 'high-contrast' | 'sepia' | 'blueprint' | 'solstice' | 'brutalism' | 'deco' | 'academia' | 'phantom' | 'ticker' | 'nishiki' | 'shade-light' | 'shade-dark' | 'mono' | 'retro' | 'grotesk' | 'tazhib' | 'nostromo'} ThemeName
 */
