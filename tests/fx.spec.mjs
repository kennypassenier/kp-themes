...
test('outside cyberpunk the effects are just the text', { tag: ['@component:page-effects'] }, async ({ page }) => {
...
test('under reduced motion the effects are just the text, in cyberpunk too [DI7]', { tag: ['@component:page-effects'] }, async ({ page }) => {
...
test('the real text reaches a screen reader whatever the effect does', { tag: ['@component:page-effects'] }, async ({ page }) => {
    await page.goto(PAGE);
